...
public class SetListPerformanceTest {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Search test time for hash set is " +
    ...
    System.out.println("Search test time for tree set is " +
    ...
    System.out.println("Search test time for array list is " +
    ...
    System.out.println("Search test time for linked list is " +
